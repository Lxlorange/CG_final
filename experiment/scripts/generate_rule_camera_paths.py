...
def make_params(task_id: str, text: str) -> dict:
    base = {
        "scene": "lego",
        "num_frames": 60,
        "radius_start": 4.0,
    ...
    elif "左向右" in text or "平移" in text:
        base.update(
            {
                "trajectory_type": "pan",
                "radius_start": 4.0,
...
def main() -> None:
    ...
    for task in data["tasks"]:
        params = make_params(task["id"], task["text"])
